  ...
  return (
    <div className="relative min-h-screen flex flex-col font-sans selection:bg-[#0072CE] selection:text-white bg-[#F8FAFC] overflow-x-hidden">
      ...
      <main className="relative z-10 flex-grow mb-[75vh] pt-48 px-8 max-w-[1400px] mx-auto pb-32">
        <span className="text-[#00A651] font-black uppercase tracking-[0.4em] text-sm font-genos">Legal</span>
        ...
        <p className="text-slate-400 text-lg font-medium mt-6 mb-24 max-w-xl leading-relaxed">Last updated: January 2026. The Physical Internet Ltd is committed to protecting your data and being transparent about how we use it.</p>

        <div className="space-y-12">
          {sections.map((section, i) => (
            <div key={i} className="bg-white rounded-[3rem] border border-slate-100 shadow-sm p-12 grid grid-cols-12 gap-8">
              <div className="col-span-12 md:col-span-3">
                <span className="text-[#0072CE] font-black uppercase text-xs tracking-widest">0{i + 1}</span>

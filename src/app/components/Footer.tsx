...
export default function Footer() {
  ...
  return (
    <footer className="sticky bottom-0 left-0 w-full min-h-[75vh] bg-[#002D72] text-white z-0 flex flex-col justify-between p-6 py-12 md:p-12 lg:p-24 overflow-hidden">
      <div className="max-w-[1400px] mx-auto w-full grid grid-cols-12 gap-12 font-genos font-proper">
        <div className="col-span-12 lg:col-span-6">
          <h2 className="text-[14vw] md:text-[12vw] lg:text-[8vw] font-black italic tracking-tighter leading-[0.8] mb-8 md:mb-12 text-proper">
      ...
      <div className="max-w-[1400px] mx-auto w-full pt-8 md:pt-12 mt-8 md:mt-0 border-t border-white/10 text-[10px] uppercase tracking-[0.2em] md:tracking-[0.4em] flex flex-col md:flex-row justify-between gap-4 font-proper">

              ...
              {items.length > 0 && (
                <div className="p-8 bg-slate-50 border-t border-slate-100">
                  ...
                  <button 
                    ...
                    className="w-full bg-[#002D72] text-white py-6 rounded-2xl font-black uppercase tracking-[0.2em] text-xs hover:bg-[#0072CE] transition-all shadow-xl shadow-blue-900/10 flex items-center justify-center gap-3 mb-4"
                  >
